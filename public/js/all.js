...
$('#category').on('change', function(){
    ...
    {
        document.getElementById('factsfigures').style.display = "none";
        $("input[name=file]").prop("multiple", true);
    }
    else
    {
        document.getElementById('factsfigures').style.display = "block"
        $("input[name=file]").prop("multiple", false);
    }
});
